// Centralised icon set — all Heroicons outline, 24×24 viewBox.
// Usage: <Icon name="refresh" size={16} />

type IconName = "refresh" | "trash" | "settings" | "send" | "stop" | "user" | "sparkles";

const PATHS: Record<IconName, string> = {
  // Arrow path (refresh / re-read)
  refresh:
  ...
  // User circle (you / human messages)
